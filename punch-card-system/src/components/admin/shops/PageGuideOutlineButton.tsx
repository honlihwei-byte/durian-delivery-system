    ...
    <div className="space-y-3">
      ...
      {open ? (
        <section className="rounded-xl border border-blue-200 bg-blue-50/60 px-4 py-4 text-sm text-blue-950">
          <p className="text-xs font-semibold uppercase tracking-wide text-blue-800/70">What this page does</p>
          <p className="mt-1">{guide.what}</p>
          <p className="mt-3 text-xs font-semibold uppercase tracking-wide text-blue-800/70">How to use it</p>
